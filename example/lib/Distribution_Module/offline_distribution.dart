...
class _OfflineDistributionState extends State<OfflineDistribution> {
  ...
  void _navigateToCreateCalendar(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => CreateCalendar(taiKhoan: widget.taiKhoan!)),
    );
  }
  ...
  void _navigateToHistoryDistribution(BuildContext context) {
    Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              HistoryDistribution(taiKhoan: widget.taiKhoan!)),
    );
  }
  ...
  void navigateToCalendarDeleted(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => CalendarDeleted(taiKhoan: widget.taiKhoan)),
    );
  }
