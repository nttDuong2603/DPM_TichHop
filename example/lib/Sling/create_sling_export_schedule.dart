...
class CreateSlingExportSchedule extends StatefulWidget {
  final String taiKhoan;

  const CreateSlingExportSchedule({
    Key? key,
    required this.taiKhoan,
  }) : super(key: key);

  @override
  State<CreateSlingExportSchedule> createState() =>
      _CreateSlingExportScheduleState();
}

class _CreateSlingExportScheduleState extends State<CreateSlingExportSchedule> {
  ...
  Future<void> _addEvent(BuildContext context) async {
    ...
    await dbHelper.insertEvent(event, widget.taiKhoan, tableName: "Sling");
        ...
        child: Container(
          ...
          child: ElevatedButton(
                ...
                if (_soLuongController.text.isNotEmpty) {
                  ...
                  if (soLuong > 0 && soLuong <= 100000) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content:
                            Text('Số lượng phải là một số từ 1 đến 100,000.'),
            ...
            style: TextButton.styleFrom(
              ...
              padding:
                  const EdgeInsets.symmetric(horizontal: 70.0, vertical: 6.0),
