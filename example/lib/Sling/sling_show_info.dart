...
class SlingInformationPage extends StatefulWidget {
  final String eventId;
  SlingInformationPage({Key? key, required this.eventId}) : super(key: key);

  @override
  _SlingInformationPageState createState() => _SlingInformationPageState();
}

class _SlingInformationPageState extends State<SlingInformationPage> {
