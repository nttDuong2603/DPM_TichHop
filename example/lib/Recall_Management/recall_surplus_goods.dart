...
class RecallFromSurplus extends StatefulWidget {
  final String taiKhoan;

  const RecallFromSurplus({
    Key? key,
    required this.taiKhoan,
  }) : super(key: key);

  @override
  State<RecallFromSurplus> createState() => OfflineRecallManageState();
}

class OfflineRecallManageState extends State<RecallFromSurplus> {
  ...
  void _navigateToCreateCalendarRecall(BuildContext context) {
    Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              CreateCalendarRecall(taiKhoan: widget.taiKhoan,isRecallCancel: false,)),
    );
  }
  ...
  void _navigateToHistoryCalendarRecall(BuildContext context) {
    Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              HistoryRecallManage(taiKhoan: widget.taiKhoan,isRecallCancel: false,)),
    );
  }
  ...
  void _navigateToOfflineRecallManageDeleted(BuildContext context) {
    Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              OfflineRecallManageDeleted(taiKhoan: widget.taiKhoan,isRecallCancel: false)),
    );
  }
                                ...
                                final result = await Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => SendDataRecall(
                                      event: event,
                                      onDeleteEvent: updateEventList, isSurplusGoodRecall: false,
                                    ),
                                  ),
                                );
                                if (result != null) {
