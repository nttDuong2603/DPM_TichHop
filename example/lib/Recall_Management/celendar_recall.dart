...
class CreateCalendarRecall extends StatefulWidget {
  ...
  @override
  State<CreateCalendarRecall> createState() => _CreateCalendarRecallState();
}

class _CreateCalendarRecallState extends State<CreateCalendarRecall> {
  ...
  Future<void> _addEvent(BuildContext context) async {
    ...
    String idLTH = Uuid().v4();
    final event = CalendarRecall(
      idLTH: idLTH,
      ghiChuLTH: _ghiChuController.text,
      taiKhoanID: widget.taiKhoan,
      ngayTaoLTH: formattedTime,
    );
